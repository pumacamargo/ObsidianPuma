...
## Descripción General
Hub central de todos los proyectos de trading. Incluye opciones en Webull (Wheel Strategy activa), futuros algorítmicos en NinjaTrader, y opciones en RRSP.
...
- **Prioridad:** 🔴 ALTA
- **Progreso:** 30%
- **Objetivo:** Algoritmo automático con 60%+ win rate
- **Próximo:** Definir parámetros, comenzar backtesting
- 📄 **Detalles completos:** [[Futures NinjaTrader]]

### 3. 🔵 Options Trading TD - RRSP
- **Estado:** 🔵 Planificación
- **Prioridad:** 🟡 MEDIA
- **Progreso:** 5%
- **Objetivo:** Estrategia optimizada para RRSP
- **Próximo:** Investigar límites y restricciones
- 📄 **Detalles completos:** [[Options TD RRSP]]
...
## 💡 Notas Generales
- Disciplina en ejecución de estrategias
- Documentación consistente en Trading Journal
- Revisión semanal de resultados
- Usar IA (Claude) para decisiones de entrada/salida en Webull
...
## 💡 Notas
- Mantenerse enfocado en ejecución disciplinada
- Documentar cada trade para análisis
- Revisar journals semanalmente
